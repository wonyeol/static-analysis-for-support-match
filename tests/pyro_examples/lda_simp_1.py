"""
Source: /examples/pyro/lda/lda_simp_1.py
"""
...
def guide(data, args, batch_size=None):
    ...
    with pyro.plate("documents", 1000, 32) as ind:
        ...
        if debug: 
            print("doc_topics(sampled)\t: shape={}".
                  format(doc_topics.shape))
            d = Delta(doc_topics, event_dim=1)
            print("Delta(doc_topics)\t: batch_shape={}, event_shape={}".
